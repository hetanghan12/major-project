    ...
    <div class="plans-page">
      ...
      <div class="page-header">
        <div>
          ...
          <p class="page-subtitle">Manage and configure your application's subscription tiers</p>
        </div>
      </div>
      ...
      <!-- PLANS GRID -->
      <div class="plans-grid-container" *ngIf="!loading">
...
{{ saving ? 'Saving...' : 'Save Changes' }}
  ...
  height: 16px;
    ...
    .plans-grid {
      ...
      gap: 32px;
      padding: 4px 24px 24px; /* Adjusted padding */
    }
    ...
    .plan-card.popular {
      ...
      padding: 39px 31px 31px; /* Offset for border */
